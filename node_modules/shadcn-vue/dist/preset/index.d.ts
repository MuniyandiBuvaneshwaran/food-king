...
declare const PRESET_BASES: readonly ["reka"];
declare const PRESET_STYLES: readonly ["vega", "nova", "maia", "lyra", "mira", "luma"];
declare const PRESET_BASE_COLORS: readonly ["neutral", "stone", "zinc", "mauve", "olive", "mist", "taupe"];
declare const PRESET_THEMES: readonly ["neutral", "stone", "zinc", "mauve", "olive", "mist", "taupe", "amber", "blue", "cyan", "emerald", "fuchsia", "green", "indigo", "lime", "orange", "pink", "purple", "red", "rose", "sky", "teal", "violet", "yellow"];
declare const PRESET_ICON_LIBRARIES: readonly ["lucide", "tabler", "hugeicons", "phosphor", "remixicon"];
declare const PRESET_FONTS: readonly ["inter", "geist-sans", "noto-sans", "nunito-sans", "figtree", "roboto", "raleway", "dm-sans", "public-sans", "outfit", "jetbrains-mono"];
declare const PRESET_FONT_HEADINGS: readonly ["inherit", "inter", "geist-sans", "noto-sans", "nunito-sans", "figtree", "roboto", "raleway", "dm-sans", "public-sans", "outfit", "jetbrains-mono"];
declare const PRESET_CHART_COLORS: readonly ["neutral", "stone", "zinc", "mauve", "olive", "mist", "taupe", "amber", "blue", "cyan", "emerald", "fuchsia", "green", "indigo", "lime", "orange", "pink", "purple", "red", "rose", "sky", "teal", "violet", "yellow"];
